...
$editTargetDate = $_REQUEST["ddate"];
if ($editTargetDate == null || $editTargetDate !== date("Y-m-d", strtotime($editTargetDate))) {
        ...
        <div  class="row">
            ...
            <div class="container">
              ...
              <div class="container col-md-5 col-sm-5 ">
                <form method="POST" action="./order_edit_confirm.php">
                  <input type="hidden" name="editTargetDate" value="<?php echo $editTargetDate; ?>">
                  <br /><br />
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php echo $price * $purchaseNumber; ?></td>
                            <td><input id="modNum" name="<?php echo $purchaseHistoryId; ?>" type="number" class="form-control inputProductNumber" value="<?php echo $purchaseNumber; ?>"></td>
                            <!-- <td id="modPrice" name="modPrice">0</td>-->
                          </tr>
                        <?php } ?>
                      </tbody>
                  </table>
                  <button type="submit" class="btn btn-primary btn-lg btn-block">変更内容を確認する</button>
                </form>
                </div>
